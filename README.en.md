...
from the real `run()` dependencies): [**rendered diagram**](https://aliarslan47.github.io/BacForge/pipeline_architecture.html) · source: `docs/pipeline_architecture.html`.
